...
def predict_age(path_to_image):
    
    img = Image.fromarray(path_to_image)
    # img = img.convert("L")
    img_cls = ['Youngster','Senior Citizen','Adult']
    ...
    model_pred.load_state_dict(torch.load("face_detect_0.8642578125.pth",map_location=torch.device("cpu")))
